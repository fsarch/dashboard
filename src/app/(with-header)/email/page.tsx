...
export default async function Home() {
  const foundServices = await getServiceConfigurations(EServiceType.EMAIL_SERVER);

  if (foundServices.length === 1) {
    return redirect(`${APPS[EServiceType.EMAIL_SERVER].basePath}/${foundServices[0].id}`);
  }

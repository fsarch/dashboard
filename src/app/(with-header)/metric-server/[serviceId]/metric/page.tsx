...
export default async function MetricsPage({
  ...
  if (!metricTypeId) {
    ...
    const metricTypes = await metricServerService.listMetricTypes(
      { page: 1, pageSize: 1 },
      serviceId
    );
    ...
    return redirect(`/metric-server/${serviceId}/metric?metricTypeId=${metricTypes.data[0].id}&page=1&pageSize=25`);
  }

  const metrics = await metricServerService.listMetrics(
